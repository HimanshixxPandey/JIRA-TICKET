...
//getting data from local storage, for re-rendering objects
if(localStorage.getItem("tickets"))
{
ticketsArr=JSON.parse(localStorage.getItem("tickets"));
ticketsArr.forEach(ticketObj=> createTicket(ticketObj.ticketColor,ticketObj.ticketObj,ticketObj.ticketId))
}
...
function handleLock(ticketCont, id) {
  ...
  console.log(ticketLock.children[0].classlist[0]);
